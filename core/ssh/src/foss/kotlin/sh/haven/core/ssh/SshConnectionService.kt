...
/**
 * FOSS variant — RDP excluded (requires proprietary native library).
 */
@AndroidEntryPoint
class SshConnectionService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        val count = sshActive.size + rnsActive.size + moshActive.size + etActive.size + localActive.size
        ...
        val labels = (sshLabels + rnsLabels + moshLabels + etLabels + localLabels).joinToString(", ")
